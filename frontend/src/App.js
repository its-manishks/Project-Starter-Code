...
function App() {
  const stripePromise = loadStripe(
    "pk_test_51OtSMcSDrFjqGHfQbFtUnaNMef1tq54OB5z4gVLOaczFlDls4JZvEJrfEuWuRwuEPzu1vUxtHqmbCJrMyPnQ3Rh100Z1xcHq2W"
  );
  ...
  // manages the routing configuration for the applications
