import React, { useEffect, useState,prev} from "react";
import PropTypes from "prop-types"; // for type-checking props 
import "../../CSS/FilterModal.css";
import "react-input-range/lib/css/index.css"; //Importing CSS file for input ran
...
selectedFilters.propertyType ||""// Default it is empty or the selected pro
...
const handlePriceRangeChange = (value) => {
    setPriceRange(value); //it will update the price range stat };
};
...
const handleClearFilters = () => {
    setPriceRange({ min: 600, max: 30000 }); // reset the price r
    setPropertyType("");
    setRoomType("");
    setAmenities ([]);
    };
...
const handleAmenitiesChange = (selectedAmenity) => {
    ...
    // function to handle changes in propertysType
    ...
    <div className="modal-content">
        ...
        <div className="modal-filters-container">
            ...
            <div className="filter-section">
                ...
                {propertTypeOptions.map((options)=>(
                <div 
                key={options.value}
        ...
        <div className="filter-section">
            ...
            <div className="amenities-checkboxes">
                {amenitiesOptions.map((option)=>( <div key={option.value} className="amenity-checkbox">
